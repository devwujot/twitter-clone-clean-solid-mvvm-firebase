...
class StoreTweetImage(private val firebaseRepository: FirebaseRepository) {
    ...
    operator fun invoke(imageUrl: Uri, image: MutableLiveData<String>, isLoading: MutableLiveData<Boolean>) = firebaseRepository.storeTweetImage(imageUrl, image, isLoading)
}